  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          { label: "Total Spend", value: `$${totalSpend.toLocaleString()}`, icon: <DollarSign size={18} className="text-[#F2DD48]" />, bg: "bg-yellow-500/10" },
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <div className="p-2 rounded-lg bg-yellow-500/10">
                          <Ticket size={16} className="text-[#F2DD48]" />
                        </div>
                        <div>
                      ...
                      <div className="flex flex-wrap gap-4 text-xs text-muted-foreground mb-3">
                        ...
                        {ev.website && (
                          <a href={ev.website} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 text-[#F2DD48] hover:underline">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-3">
                        ...
                        <div className="bg-muted/30 rounded-lg p-3">
                          ...
                          <p className="text-lg font-bold text-[#F2DD48]">{ev.teamSignups ?? 0}</p>
