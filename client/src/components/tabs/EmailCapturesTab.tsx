 ...
 * Route         : No new route needed — rendered as <Tab value="email-leads"> inside Members
 * Sidebar       : NO new sidebar item — lives inside Members > Email Leads tab
 *
...
// CommunicationPanel — update import path after placing file in project
...
// Status badge colors — uses only shadcn/Tailwind semantic tokens (light-theme safe)
const STATUS_COLORS: Record<Status, string> = {
  new:          "bg-primary/10 text-primary border border-primary/20",
  contacted:    "bg-muted text-foreground border border-border",
  qualified:    "bg-primary/20 text-foreground border border-primary/30",
  converted:    "bg-primary text-primary-foreground border border-primary",
  unsubscribed: "bg-muted text-muted-foreground border border-border",
  bounced:      "bg-destructive/10 text-destructive border border-destructive/20",
};
...
//   <TabsContent value="email-leads"><EmailCapturesTab /></TabsContent>
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem
                          onClick={() =>
                            syncToEncharge.mutate({ ids: [lead.id] })
                          }
...
// EmailCapturesPage is the default export (full page with DashboardLayout)
// EmailCapturesTab is the named export (embeddable tab component)
