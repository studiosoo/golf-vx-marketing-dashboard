...
function Section({
  ...
  return (
    <div className="bg-white border border-[#E9E9E6] rounded-xl overflow-hidden">
      <button
        className="w-full flex items-center justify-between px-4 py-3 text-left hover:bg-[#F6F6F4] transition-colors"
...
export function AIInsightsPanel({
  ...
  return (
    <div className="bg-white border border-[#E9E9E6] rounded-xl overflow-hidden">
      {/* Panel Header */}
      <button
        className="w-full flex items-center justify-between px-5 py-4 text-left hover:bg-[#F6F6F4] transition-colors"
          ...
          {!insights && !generateMutation.isPending && (
            <div className="flex flex-col items-center justify-center py-10 space-y-3 text-center">
              ...
              <div>
                ...
                <p className="text-xs text-[#6F6F6B] mt-1 max-w-xs">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  className="border-[#E9E9E6] text-[#545A60] hover:bg-[#F1F1EF] text-xs h-7"
                >
              ...
              {insights.insights?.performanceAssessment && (
                <div className={`rounded-xl p-3 border ${
                  ...
                  insights.insights.performanceAssessment.status === "ahead" ? "bg-[#6F6F6B]/10 border-blue-200" :
