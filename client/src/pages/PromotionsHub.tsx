        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4 max-h-[80vh] overflow-y-auto">
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-[#DEDEDA] rounded-lg px-3 py-2 text-[13px] text-[#222222] placeholder:text-[#AAAAAA] focus:outline-none focus:ring-1 focus:ring-[#F2DD48]"
            />
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="flex-1 border border-[#DEDEDA] rounded-lg px-3 py-2 text-[13px] text-[#222222] placeholder:text-[#AAAAAA] focus:outline-none focus:ring-1 focus:ring-[#F2DD48]"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full border border-[#DEDEDA] rounded-lg px-3 py-2 text-[13px] text-[#222222] placeholder:text-[#AAAAAA] focus:outline-none focus:ring-1 focus:ring-[#F2DD48] resize-none"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-[#DEDEDA] rounded-lg px-3 py-2 text-[13px] text-[#222222] placeholder:text-[#AAAAAA] focus:outline-none focus:ring-1 focus:ring-[#F2DD48]"
            />
            <p className="text-[11px] text-[#AAAAAA] mt-1">Applied to every contact who claims this offer. Also adds <code className="bg-[#F1F1EF] px-1 rounded">promo-{form.slug || "slug"}</code></p>
          </div>
          ...
          <div className="flex gap-2 pt-1">
            <button type="button" onClick={onClose} className="flex-1 h-10 border border-[#DEDEDA] rounded-lg text-[13px] font-semibold text-[#888888] hover:bg-[#F1F1EF]">Cancel</button>
            <button
              type="submit"
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl p-6 shadow-2xl w-full max-w-xs mx-4 text-center">
        ...
        <div className="mt-4 flex items-center gap-2 bg-[#F1F1EF] rounded-lg px-3 py-2">
          ...
          <button onClick={copy} className="shrink-0 text-[#888888] hover:text-[#222222]">
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1.5 mb-2 flex-wrap">
            ...
            <span className="text-[10px] text-[#888888] bg-[#F1F1EF] px-2 h-5 rounded-full flex items-center">
          ...
          <div className="flex items-center gap-3 mt-3">
            <button onClick={onSelect} className="flex items-center gap-1 text-[12px] font-semibold text-[#888888] hover:text-[#222222]">
        ...
        <div className="flex flex-col gap-1.5 shrink-0">
          ...
          <button
            ...
            className={cn(
              ...
              promo.status === "active"
                ? "border border-[#DEDEDA] text-[#888888] hover:border-red-200 hover:text-red-400"
        ...
        {([
          ...
          <button
            ...
            className={cn(
              ...
              tab === key ? "text-[#222222] border-[#F2DD48]" : "text-[#888888] border-transparent hover:text-[#222222]"
            )}
          >
            {label}
          </button>
