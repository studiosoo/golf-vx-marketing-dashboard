  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">Golf league management and tracking</p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="space-y-3">
          {(campaigns as any[]).map((league: any) => (
            <Card key={league.id} className="bg-card border-border">
              <CardContent className="p-5">
                ...
                <div className="grid grid-cols-3 gap-3 mt-3">
                  <div className="text-center">
                    <div className="text-sm font-semibold text-foreground">${parseFloat(String(league.actualRevenue || 0)).toLocaleString()}</div>
                    <div className="text-xs text-muted-foreground">Revenue</div>
                  </div>
                  <div className="text-center">
                    <div className="text-sm font-semibold text-foreground">${parseFloat(String(league.actualSpend || 0)).toLocaleString()}</div>
