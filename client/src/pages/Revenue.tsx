  ...
  return (
    <div className="bg-white rounded-xl border border-[#DEDEDA] p-4 shadow-[0_1px_4px_rgba(0,0,0,0.06)]">
      <div className="flex items-start justify-between mb-2">
        ...
        <div className="h-7 w-7 rounded-lg bg-[#F1F1EF] flex items-center justify-center text-[#888888]">
          {icon}
        </div>
      </div>
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-xl border border-[#DEDEDA] p-5 shadow-[0_1px_4px_rgba(0,0,0,0.06)]">
        ...
        <div className="h-3 bg-[#F1F1EF] rounded-full overflow-hidden mb-2">
        ...
        {!hasRevenue && (
          <p className="text-[11px] text-[#AAAAAA] mt-3 p-2 rounded-lg bg-[#FAFAFA] border border-dashed border-[#DEDEDA]">
