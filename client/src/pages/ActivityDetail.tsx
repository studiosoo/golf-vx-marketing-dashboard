...
function ContentTab({ item }: { item: ActivityItem }) {
  return (
    <div className="space-y-4">
      ...
      {item.contentAssets == null || item.contentAssets.length === 0 && (
        <EmptyState icon={<CheckSquare size={18} />} message="No content assets logged yet." />
      )}
    </div>
  );
}
...
export default function ActivityDetail() {
  ...
  return (
    <div className="p-8 space-y-6">
      ...
      {activeDetailTab === "content"    && <ContentTab item={item} />}
