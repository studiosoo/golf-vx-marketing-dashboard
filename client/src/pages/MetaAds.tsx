    ...
    <div className={embedded ? "space-y-6" : "p-6 space-y-6"}>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        {!embedded && <div>
          ...
          <p className="text-[#6F6F6B] text-sm mt-1">Facebook & Instagram campaign performance</p>
        </div>}
        {embedded && <div />}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: "Active Spend", value: formatCurrency(totalSpend), icon: <DollarSign size={18} />, color: "text-[#FF3B30]" },
          { label: "Total Reach", value: formatNum(totalReach), icon: <Eye size={18} />, color: "text-[#6F6F6B]" },
          { label: "Impressions", value: formatNum(totalImpressions), icon: <TrendingUp size={18} />, color: "text-[#72B84A]" },
          { label: "Clicks", value: formatNum(totalClicks), icon: <MousePointer size={18} />, color: "text-[#F2DD48]" },
        ].map((kpi) => (
