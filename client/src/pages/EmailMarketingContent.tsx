      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="bg-card border-border">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Active email subscribers</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-card border-border">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">New subscribers (last 30 days)</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-card border-border">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Active audience segments</p>
          </CardContent>
        </Card>
